...
/**
 * Solver to be used to find the CSS filters that would convert a black image to the target color.
 */
class Solver {
  target: Color;
  targetHSL: {
...
/**
 * Returns a CSS filter that will convert a black image to the given color.
 * @param rgb The color to convert to.
 * @returns A CSS filter that will convert a black image to the given color.
 */
